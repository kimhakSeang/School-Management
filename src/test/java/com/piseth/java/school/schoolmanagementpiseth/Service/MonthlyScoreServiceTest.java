...
public class MonthlyScoreServiceTest {
     ...
     public void setUp() {
  	   ...
  	   monthlyScore.setMonth((Integer) 12);
  	   monthlyScore.setYear((Integer) 2022);
  	   ...
  	   monthlyFilter.setYear((Integer) 2022);
  	   monthlyFilter.setMonth((Integer) 11);
  	   monthlyFilter.setGrade((Integer) 12);
